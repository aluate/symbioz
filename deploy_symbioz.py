#!/usr/bin/env python3
"""
Quick script to ask Otto to deploy Symbioz/Mellivox and fix any errors
"""
...
def main():
    ...
    print("🚀 Asking Otto to deploy Symbioz/Mellivox and fix any errors...")
    print()
    ...
    task = Task(
        ...
        payload={
            "project_path": ".",  # Root of symbioz repo
            "project_name": "symbioz",  # Must match config in vercel.yaml and render.yaml
            "max_iterations": 5
        },
        source="cli",
